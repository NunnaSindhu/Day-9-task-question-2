// Solving problems using array functions on rest countries data.Get all the countries with a population of less than 2 lakhs using Filter function
...
xhr.onload = function () {
  ...
  // console.log(data);
  let countrypopulation = data.filter((country) => {
